...
const ABAlias_json_withSub: ABAlias_json_item[] = [
  { regex: /\|::: 140lne\|(info|note|warning|caution|attention|error|danger|tips|tip|hint|example|abstract|summary|tldr|quote|cite|todo|success|check|done|important|question|help|faq|failure|fail|missing|bug)\s?(.*?)\|/, replacement: "|add([!$1] $2)|quote|" },
